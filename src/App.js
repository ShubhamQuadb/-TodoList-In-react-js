...
//import { tsk_backend } from 'declarations/tsk_backend';
...
//import MoonIcon from '/mnt/data/Vector (1).png'; // Add this line
...
/*
  ...
  const handleGreetingSubmit = (event) => {
    ...
    tsk_backend.greet(name).then((greeting) => {
      ...
      <div className={`container-center ${darkMode ? 'dark' : ''}`}>
        <div className={`flex-area ${darkMode ? 'dark' : ''} bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 w-full max-w-md`}>
          ...
          <div className="flex items-center mb-4">
            ...
            >
                {darkMode ? <img src="/image/Vector (2).png" alt="sun icon" style={{ width: '1.6em' }} /> : <img src="/image/Vector (1).png" alt="moon icon" style={{ width: '1.6em' }} />}
            </Button>
          </div>
