...
import './NewNoteForm.css'; // Make sure to import the CSS file
...
function NewNoteForm({ addNote, closeModal, currentNote, darkMode }) {
  ...
  return (
    <div className={`container-center fixed inset-0 ${darkMode ? 'dark' : ''}`}>
      <div className={`new-note-form bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-full max-w-sm sm:max-w-md`}>
